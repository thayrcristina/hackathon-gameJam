...
public class FantasmaRosa : MonoBehaviour
{
    ...
    float[] x = { 2.2f, 1.1f, 1.1f, 0.2f, 0.2f, 0.5f, 0.5f, 0.2f, 0.2f, 0.5f, 0.5f, 1.1f, 1.1f, 1.7f, 2.2f, 2.2f, 2.8f, 2.8f, 3.3f, 3.3f, 2.8f, 2.8f, 2.2f };
    float[] y = { 3.5f, 3.5f, 5.3f, 5.3f, 4.1f, 4.1f, 3.5f, 3.5f, 2.4f, 2.4f, 1.9f, 1.9f, 4.6f, 4.6f, 4.6f, 5.0f, 5.0f, 4.6f, 4.6f, 4.1f, 4.1f, 3.5f, 3.5f };
    int ponto = 0;
